          ...
          <div className="grid grid-cols-4 gap-4">
            {images.map((img, idx) => (
              <button
                ...
                className={`relative aspect-square rounded-xl overflow-hidden border-2 transition-all ${activeImageIndex === idx ? 'border-red-500 ring-2 ring-red-100' : 'border-gray-100 hover:border-gray-300'
                  }`}
              >
                {img.startsWith('data:') ? (
          ...
          {(() => {
            ...
            if (quantityInCart === 0) {
              return (
                <div className="mt-12">
                  <Button
                    className="w-full h-16 bg-[#0a192f] hover:bg-[#152a45] text-white font-black text-xl shadow-xl shadow-blue-100 uppercase tracking-widest rounded-2xl transition-all active:scale-95"
            ...
            return (
              <div className="mt-12 flex flex-col md:flex-row gap-6 items-center bg-red-50 p-6 rounded-2xl border border-red-100">
                <div className="flex-shrink-0">
                  <div className="text-[10px] uppercase font-bold text-red-600 mb-2 text-center">Quantité ajoutée</div>
                  <QuantitySelector
                ...
                <div className="flex-1 text-center md:text-left">
                  <p className="text-[#0a192f] font-black text-lg">{quantityInCart} article(s) dans votre panier.</p>
                  <p className="text-sm font-bold text-red-600">Prix de groupe activé !</p>
                </div>
                <Button
                  variant="ghost"
